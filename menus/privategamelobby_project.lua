...
CoD.PrivateGameLobby.CustomSurvivals[1].labels[2] = "NACHT DER UNTOTEN"
CoD.PrivateGameLobby.CustomSurvivals[1].labels[3] = "DINER"
CoD.PrivateGameLobby.CustomSurvivals[1].labels[4] = "BUS RIDE"
CoD.PrivateGameLobby.CustomSurvivals[1].labels[5] = "BURNING FOREST"
CoD.PrivateGameLobby.CustomSurvivals[1].labels[6] = "LABORATORY"
CoD.PrivateGameLobby.CustomSurvivals[1].values = {}
CoD.PrivateGameLobby.CustomSurvivals[1].values[1] = 0
CoD.PrivateGameLobby.CustomSurvivals[1].values[2] = 1
CoD.PrivateGameLobby.CustomSurvivals[1].values[3] = 2
CoD.PrivateGameLobby.CustomSurvivals[1].values[4] = 3
CoD.PrivateGameLobby.CustomSurvivals[1].values[5] = 4
CoD.PrivateGameLobby.CustomSurvivals[1].values[6] = 5
...
CoD.PrivateGameLobby.CustomSurvivals[2] = {}
CoD.PrivateGameLobby.CustomSurvivals[2].id = "CUSTOM_MAP"
CoD.PrivateGameLobby.CustomSurvivals[2].name = "CUSTOM SURVIVAL MAPS"
CoD.PrivateGameLobby.CustomSurvivals[2].hintText = "Select Survival Map."
CoD.PrivateGameLobby.CustomSurvivals[2].labels = {}
CoD.PrivateGameLobby.CustomSurvivals[2].labels[1] = "DISABLED"
CoD.PrivateGameLobby.CustomSurvivals[2].labels[2] = "BRIDGE"
CoD.PrivateGameLobby.CustomSurvivals[2].labels[3] = "ROOFTOP"
CoD.PrivateGameLobby.CustomSurvivals[2].values = {}
CoD.PrivateGameLobby.CustomSurvivals[2].values[1] = 0
CoD.PrivateGameLobby.CustomSurvivals[2].values[2] = 1
CoD.PrivateGameLobby.CustomSurvivals[2].values[3] = 2
CoD.PrivateGameLobby.CustomSurvivals[2].maps = {}
CoD.PrivateGameLobby.CustomSurvivals[2].maps[1] = "zm_prison"
CoD.PrivateGameLobby.CustomSurvivals[2].gameTypes = {}
CoD.PrivateGameLobby.CustomSurvivals[2].gameTypes[1] = "zclassic"
--[[
...
CoD.PrivateGameLobby.CustomSurvivals[3].values[1] = "0"
...
CoD.PrivateGameLobby.CustomSurvivals[4].values[1] = "0"
...
CoD.PrivateGameLobby.LRZ = {}
CoD.PrivateGameLobby.LRZ[1] = {}
CoD.PrivateGameLobby.LRZ[1].id = "LRZ_enabled"
CoD.PrivateGameLobby.LRZ[1].name = "LRZ++"
CoD.PrivateGameLobby.LRZ[1].hintText = "Enable/Disable Loki's Ragnarok Zombies ++."
CoD.PrivateGameLobby.LRZ[1].labels = {}
CoD.PrivateGameLobby.LRZ[1].labels[1] = "ENABLED"
CoD.PrivateGameLobby.LRZ[1].labels[2] = "DISABLED"
CoD.PrivateGameLobby.LRZ[1].values = {}
CoD.PrivateGameLobby.LRZ[1].values[1] = 1
CoD.PrivateGameLobby.LRZ[1].values[2] = 0
CoD.PrivateGameLobby.LRZ[1].gameTypes = {}
CoD.PrivateGameLobby.LRZ[1].gameTypes[1] = "zclassic"
CoD.PrivateGameLobby.LRZ[1].gameTypes[2] = "zstandard"
CoD.PrivateGameLobby.LRZ[1].gameTypes[3] = "zgrief"

CoD.PrivateGameLobby.LRZHarderZombies = {}
CoD.PrivateGameLobby.LRZHarderZombies[1] = {}
CoD.PrivateGameLobby.LRZHarderZombies[1].id = "LRZ_Harder_Zombies"
CoD.PrivateGameLobby.LRZHarderZombies[1].name = "LRZ HARDER ZOMBIES"
CoD.PrivateGameLobby.LRZHarderZombies[1].hintText = "Increase the difficulty of the zombies especially in early rounds."
CoD.PrivateGameLobby.LRZHarderZombies[1].labels = {}
CoD.PrivateGameLobby.LRZHarderZombies[1].labels[1] = "ENABLED"
CoD.PrivateGameLobby.LRZHarderZombies[1].labels[2] = "DISABLED"
CoD.PrivateGameLobby.LRZHarderZombies[1].values = {}
CoD.PrivateGameLobby.LRZHarderZombies[1].values[1] = 1
CoD.PrivateGameLobby.LRZHarderZombies[1].values[2] = 0
CoD.PrivateGameLobby.LRZHarderZombies[1].gameTypes = {}
CoD.PrivateGameLobby.LRZHarderZombies[1].gameTypes[1] = "zclassic"
CoD.PrivateGameLobby.LRZHarderZombies[1].gameTypes[2] = "zstandard"
CoD.PrivateGameLobby.LRZHarderZombies[1].gameTypes[3] = "zgrief"
...
CoD.PrivateGameLobby.DvarDefaults["LRZ_enabled"] = 1
...
CoD.PrivateGameLobby.PopulateButtons_Project_Zombie = function (PrivateGameLobbyButtonPane, IsHost)
	if IsHost == true then
		...
		-- 	PrivateGameLobbyButtonPane.body.widestButtonTextWidth = f9_local1_3
		-- end
		AddGameOptionsButtons(PrivateGameLobbyButtonPane, CoD.PrivateGameLobby.LRZ, "dvar")
		AddGameOptionsButtons(PrivateGameLobbyButtonPane, CoD.PrivateGameLobby.LRZHarderZombies, "dvar")
